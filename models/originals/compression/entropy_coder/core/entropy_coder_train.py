...
tf.compat.v1.flags.DEFINE_string('train_dir', None,
                           """Directory where to write event logs.""")
tf.compat.v1.flags.DEFINE_integer('task', None,
                            """Task id of the replica running the training.""")
tf.compat.v1.flags.DEFINE_integer('ps_tasks', 0, """Number of tasks in the ps job.
                            If 0 no ps job is used.""")

# Model selection and configuration.
tf.compat.v1.flags.DEFINE_string('model', None, """Underlying encoder model.""")
tf.compat.v1.flags.DEFINE_string('model_config', None,
                           """Model config protobuf given as text file.""")

# Training data and parameters configuration.
tf.compat.v1.flags.DEFINE_string('input_config', None,
                           """Path to the training input config file.""")
tf.compat.v1.flags.DEFINE_string('train_config', None,
